...
![코루틴 vs Virtual Thread 처리 흐름 1](../docs/images/readme-diagrams/08-coroutines-ko-diagram-01.svg)

### 스레드 모델 구조 비교

![스레드 모델 구조 비교 2](../docs/images/readme-diagrams/08-coroutines-ko-diagram-02.svg)

...
Exposed 1.0.0 기준으로 SELECT/INSERT/UPDATE/DELETE/UPSERT, 타입, 함수, 트랜잭션, Entity API까지의 조회·변경 흐름을 테스트 중심으로 정리하는 챕터입니다.
...
./gradlew :exposed-05-exposed-dml-04-transactions:test

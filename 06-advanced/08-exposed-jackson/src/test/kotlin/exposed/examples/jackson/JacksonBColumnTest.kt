...
import exposed.examples.jackson.JacksonSchema.withJacksonBArrays
import exposed.examples.jackson.JacksonSchema.withJacksonBTable
...
/**
 * Jackson 기반 JSONB 컬럼의 저장/조회/검색 기능을 검증하는 예제 테스트.
 */

...
import exposed.shared.MiscTable
...
class Ex04_MiscTable: AbstractExposedTest() {
    ...
    fun `insert 01`(testDB: TestDB) {
        ...
        withTables(testDB, tbl) {
            ...
            tbl.checkRow(
                row, 13, null, -10, null, 42, null, E.ONE, null, E.ONE,
    ...
    fun `insert 03`(testDB: TestDB) {
        ...
        withTables(testDB, tbl) {
            ...
            val row = tbl.selectAll().single()
            tbl.checkRow(
                row, 13, 13, -10, -10, 42, 42, E.ONE, E.ONE, E.ONE, E.ONE,
    ...
    fun `insert 04`(testDB: TestDB) {
        ...
        withTables(testDB, tbl) {
            ...
            val row = tbl.selectAll().single()
            tbl.checkRow(
                row, 13, null, -10, null, 42, null, E.ONE, null, E.ONE, null,
    ...
    fun `select 01`(testDB: TestDB) {
        ...
        withTables(testDB, tbl) {
            ...
            tbl.checkRowFull(
                tbl.selectAll().where { tbl.e.eq(E.ONE) }.single(),
                by = 13,
                byn = null,
                sm = -10,
                smn = null,

...
class TimebaseUUIDBase62TableTest: AbstractCustomIdTableTest() {
    ...
    @ParameterizedTest(name = "{0} - {1}개 레코드")
    @MethodSource("getTestDBAndEntityCount")
    fun `Coroutines 환경에서 TimebasedUUID Base62 Id를 가진 엔티티를 생성한다`(testDB: TestDB, recordCount: Int) = runSuspendIO {

...
![BookSchema ERD ( PK) diagram](../../docs/images/readme-diagrams/07-jpa-01-convert-jpa-basic-erd-05.png)

### Entity 클래스 다이어그램 — JPA Entity vs Exposed DAO

![Entity — JPA Entity vs Exposed DAO diagram](../../docs/images/readme-diagrams/07-jpa-01-convert-jpa-basic-class-06.png)

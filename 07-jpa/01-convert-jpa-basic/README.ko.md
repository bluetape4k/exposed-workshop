...
![관계 매핑 변환 다이어그램 1](../../docs/images/readme-diagrams/07-jpa-01-convert-jpa-basic-ko-diagram-01.svg)
...
![BookSchema ERD (복합 PK) 5](../../docs/images/readme-diagrams/07-jpa-01-convert-jpa-basic-ko-diagram-05.svg)

### Entity 클래스 다이어그램 — JPA Entity vs Exposed DAO

![Entity 클래스 다이어그램 — JPA Entity vs Exposed DAO 6](../../docs/images/readme-diagrams/07-jpa-01-convert-jpa-basic-ko-diagram-06.svg)

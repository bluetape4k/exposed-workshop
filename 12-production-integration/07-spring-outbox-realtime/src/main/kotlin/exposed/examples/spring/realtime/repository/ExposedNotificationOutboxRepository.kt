...
import exposed.examples.spring.realtime.model.OutboxStatus
...
private object Notifications : LongIdTable("spring_realtime_notifications") {
    val recipientId = varchar("recipient_id", 80)
    val message = varchar("message", 240)
}

private object RealtimeOutbox : LongIdTable("spring_realtime_outbox") {

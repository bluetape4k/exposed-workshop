package exposed.examples.ktor.realtime.persistence
...
internal class NotificationPersistence private constructor(
    ...
    companion object {
        fun inMemory(databaseName: String = "ktor_outbox_realtime"): NotificationPersistence {
            val config = HikariConfig().apply {
                ...
                password = ""
                maximumPoolSize = 4
                poolName = "ktor-outbox-realtime-$databaseName"
            }

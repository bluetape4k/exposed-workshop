...
![도메인 모델 1](../../docs/images/readme-diagrams/10-multi-tenant-01-multitenant-spring-web-ko-diagram-01.svg)

---

## 아키텍처

![아키텍처 2](../../docs/images/readme-diagrams/10-multi-tenant-01-multitenant-spring-web-ko-diagram-02.svg)

### TenantResolver 클래스 계층

![TenantResolver 클래스 계층 3](../../docs/images/readme-diagrams/10-multi-tenant-01-multitenant-spring-web-ko-diagram-03.svg)
